...
const SHELL_ASSETS = ["/", "/index.html", "/style.css?v=2.3.16", "/cashier-themes.css?v=2.3.16", "/app-migration-v2.3.js?v=2.3.16", "/payroll-reminder.js?v=2.3.16", "/manifest.webmanifest", "/logo.png", "/icons/icon-192.png", "/icons/icon-512.png", "/modules/kasaflow-module.html"];
