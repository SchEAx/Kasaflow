const CACHE_NAME = "kasaflow-migration-test-v2-3-14";
const SHELL_ASSETS = ["/", "/index.html", "/style.css?v=2.3.14", "/cashier-themes.css?v=2.3.14", "/app-migration-v2.3.js?v=2.3.14", "/payroll-reminder.js?v=2.3.14", "/manifest.webmanifest", "/logo.png", "/icons/icon-192.png", "/icons/icon-512.png"];
